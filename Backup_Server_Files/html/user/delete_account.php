...
function delete_account($user) {
    ...
    $retval = $user->update("email_addr='$x', authenticator='$x', name='', country='', postal_code='', bitshares_account='', steem_account='', gridcoin_address='', ethereum_address='', ethereum_classic_address='', nxt_account_id='', golem_address='', ardor_account_id='', hyperledger_sawtooth_lake='', hyperledger_fabric='', waves_address='', peershares_address='', omnilayer_address='', counterparty_address='', has_profile=0");
